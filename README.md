Sentinel 1
var ROI = ee.FeatureCollection("users/sk4639977//Nodehbala");
...
Map.addLayer(composite.clip(Nodehbala), {min: [-25, -20, -25], max: [0, 10, 0]}, 'composite');
...
Map.addLayer(classified.clip(Nodehbala),{min: 0, max: 9,palette: palette},"classification");
Map.centerObject(Nodehbala,10);
